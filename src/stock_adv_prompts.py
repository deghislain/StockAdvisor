...
def get_market_sentiment_analysis_prompt():
    return """
...
def get_market_sentiment_analysis_review_prompt():
    return """
    ...
    Use concise, data-driven language. Quantify deficiencies (e.g., "missing peers for P/E comparison; add 3–5 peers" or "sentiment score lacks weighting breakdown").
...
def get_market_sentiment_analysis_improve_prompt():
    logging.info("******************************Loading Improve prompt******************")
    return """
        You are a **Senior Financial Analyst** with extensive expertise in **reviewing 
